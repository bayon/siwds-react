  ...
  render() {
    return (
      <div className="Home container">
        ...
        <h2 className="page-title">About Us and the Wave Dissipation System (WDS)</h2>
          <div className="row xxxsi-section">
              
              <div className="col">
                  <div className="">
                      <p><img className="" src="http://104.248.117.168/wp-content/uploads/2018/03/IMG_4581-169x300.jpg" alt="" width="169" height="300" srcSet="http://104.248.117.168/wp-content/uploads/2018/03/IMG_4581-169x300.jpg 169w, http://104.248.117.168/wp-content/uploads/2018/03/IMG_4581-367x650.jpg 367w, http://104.248.117.168/wp-content/uploads/2018/03/IMG_4581.jpg 413w" sizes="(max-width: 169px) 100vw, 169px" /></p>
